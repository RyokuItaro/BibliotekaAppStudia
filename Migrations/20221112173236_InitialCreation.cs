    ...
    public partial class InitialCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BorrowCartId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowCarts", x => x.BorrowCartId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowCartItems_BorrowCartId",
                table: "BorrowCartItems",
                column: "BorrowCartId");
